...
namespace SoundTouch
{
    ...
    public sealed class FifoSampleBuffer<TSampleType> : FifoSamplePipe<TSampleType> where TSampleType : struct
    {
        ...
        {
            //Console.WriteLine("FifoSampleBuffer.PutSamles...CopyBytes... len1={0},len2={1},count={2}...plus1={3},plus2={4}", PtrEnd(numSamples).GetLength(), samples.GetLength(), SIZEOF_SAMPLETYPE * numSamples * _channels, PtrEnd(numSamples).GetIndex() + SIZEOF_SAMPLETYPE * numSamples * _channels, samples.GetIndex() + SIZEOF_SAMPLETYPE * numSamples * _channels);
        ...
        public override int ReceiveSamples(ArrayPtr<TSampleType> output, int maxSamples)
        {
            ...
            //Console.WriteLine("FifoSampleBuffer.ReceiveSamples...CopyByte... len1={0},len2={1},count={2}", output.GetLength(), PtrBegin().GetLength(), _channels * SIZEOF_SAMPLETYPE * num);
