...
namespace WavePlayer.WavPlayer.SoundBuffer
{
	...
	public class BufferNotificationEventArgs : EventArgs
	{
		...
		/// </summary>
        public int NumBytesRequired { get { return NumBytesRequiredRep; } set { NumBytesRequiredRep = value; } }
	...
	public class EventRaisingSoundBuffer
	{
		...
		protected void InitSecondaryBuffer()	
		{
            ...
            description.Flags = description.Flags| BufferDescriptionFlags.GlobalFocus;
			...
			while (!bterminate)
			{
				...
				switch(task)
				{
					...
					default: // NextNotificationTask.StopSecondaryBufferAndThread
						SB.Stop();
                        if (PlayFinishedHandler != null)
                        {
                            PlayFinishedHandler.Invoke(this, new EventArgs());
                        }
        ...
        public event EventHandler PlayFinishedHandler;
		...
		public bool Playing
		{
			get 
            {
                ...
                return  (SB.Status.Looping || SB.Status.Playing); 
            }
			set
			{
        ...
        private volatile bool bterminate = false;
        public void terminate()
        {
            SB.Stop(); 
            bterminate = true;
            playPositionWhileStop = -1;
        }

        int playPositionWhileStop = -1;
		public void Stop()
		{
			if (Playing) 
			{
                playPositionWhileStop = SB.PlayPosition;
